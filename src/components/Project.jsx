    ...
    return (
        <div className='md:h-screen overflow-y-scroll xs:h-[700px] bg-white h-screen relative'>
            ...
            <div className='records w-full flex bg-white items-center'>
                <div onClick={() => setCurrent_tab('earning')} className={`cursor-pointer h-[40px] flex items-center justify-center w-1/2 text-center border-b-4 font-semibold ${current_tab === 'earning' ? 'border-red-800 text-red-800' : 'text-gray-400'}`}>Income</div>
                <div onClick={() => setCurrent_tab('completed')} className={`cursor-pointer h-[40px] flex items-center justify-center w-1/2 text-center border-b-4 ${current_tab === 'completed' ? 'border-red-800 text-red-800' : 'text-gray-400'}`}>Finish</div>
            </div>
