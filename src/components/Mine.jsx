  ...
  return (
    <div className='relative h-screen bg-white'>
      ...
      <div className="flex flex-col bg-white gap-3">
        ...
        <div className='flex flex-row w-full justify-between px-4 text-white items-center h-28 rounded-lg bg-red-800'>
      ...
      <div className='flex flex-col px-2 gap-4 py-3'>
        <div className='flex flex-row gap-2 items-center' onClick={() => navigate('/project')}>
          <div>
            <img src={my1} className="w-6" />
          </div>
          <div className='font-semibold'>Product Details</div>
        </div>

        <div className='flex flex-row gap-2 items-center' onClick={() => navigate('/record')}>
          <div>
            <img src={my2} className="w-6" />
          </div>
          <div className='font-semibold'>Account Record</div>
        </div>

        <div className='flex flex-row gap-2 items-center'>
          <div>
            <img src={my3} className="w-6" />
          </div>
          <div className='font-semibold'>APP Download</div>
        </div>

        <div className='flex flex-row gap-2 items-center' onClick={() => navigate('/settings', { state: { withdrawalPassword: originalwpwd, loginPassword: originalpwd } })}>
          <div>
            <img src={my4} className="w-6" />
          </div>
          <div className='font-semibold'>Personal Information</div>
        </div>

        <div className='flex flex-row gap-2 items-center' onClick={() => navigate('/company')}>
          <div>
      ...
      <div onClick={() => setLogout_popup(true)} className="flex flex-row justify-center text-xl
        w-[80%] mx-auto py-1 mt-10 text-center rounded-md bg-red-800 text-white text-semibold">
        <div>Sign out</div>
      </div>
